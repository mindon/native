...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>zero-native.command.list</code></td>
      <td><code>command</code></td>
...
.builtin_bridge = .{
    ...
    .commands = &.{
        ...
        .{ .name = "zero-native.command.list", .permissions = .{ "command" }, .origins = .{ "zero://app" } },
