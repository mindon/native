...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>PlatformServices.showOpenDialog(...)</code> / <code>showSaveDialog(...)</code> / <code>showMessageDialog(...)</code></td>
      <td><code>zero-native.dialog.openFile</code> / <code>saveFile</code> / <code>showMessage</code></td>
